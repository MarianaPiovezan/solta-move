...
export const Sale = () => {
  ...
  return (
    <>
      <section aria-label="Confira todos os nossos planos" className="  ">
          ...
          <div className="container-margin pt-12 md:pt-16 md:grid grid-cols-2 gap-6 md:gap-8 px-6 xl:px-0">
            <div className="flex  flex-col gap-6 md:gap-8 justify-center   max-w-2xl mx-auto mb-6 md:mb-8 ">
              ...
              >
                ...
                não se sentir mais viva, confiante e saudável, basta cancelar
                sua assinatura dentro deste período da garantia. Reembolsamos
                100% do valor do seu plano e continuamos amigas.
              </motion.p>
            </div>
            <motion.img
        ...
        <div className=" py-12 md:py-16 px-6 xl:px-0 max-w-2xl mx-auto flex flex-col items-center gap-2 hidden">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-brand-gray-800 text-center">
              Mulheres que ganham até 2 salários mínimos são as que menos
              praticam atividade física no Brasil*.{" "}
