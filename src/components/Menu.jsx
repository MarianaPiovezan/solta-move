...
export const Menu = () => {
  return (
    <header className="bg-brand-yellow h-[4.5rem] md:h-[5rem] top-2 md:top-4 rounded-xl left-2 right-2 md:left-4 md:right-4 z-50 fixed scroll-smooth shadow-lg flex items-center font-extrabold text-sm md:text-lg px-6">
      <nav aria-label="Navegação principal" className="flex justify-between container-margin items-center w-full gap-3">
        <a href="#hero"><img className="w-12 md:w-16 " src={logo} alt="Solta Move" loading="lazy" /></a>
