...
export const CardSale = ({ cards = {}}) => {
  return (
    <>
      {/* Fita "Mais Escolhido" */}
      <div id={`${cards.category}`} className="scroll-mt-80">
        <motion.div
          className="flex flex-col items-center justify-center hover:scale-105 w-full  duration-300 ease-in-out overflow-visible "
