...
export const CardSale = ({ cards = {}, delay, inView }) => {
  return (
    <>
      {/* Fita "Mais Escolhido" */}
      <motion.div id={`${cards.category}`} className="flex flex-col items-center justify-center hover:scale-105 w-full  duration-300 ease-in-out overflow-visible scroll-mt-80"  initial={{ opacity: 0, x: -30 }}
